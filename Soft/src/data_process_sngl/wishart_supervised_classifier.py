...
@numba.njit(parallel=False)
def wishart_supervised_classifier_alg(sub_n_col, valid, n_win_l_m1s2, lig, n_win_c_m1s2, pol_type, n_area, n_pp, cov_area_m1, m_avg, distance, det_area, pol_type_out, eps, m, coh_m1, init_minmax, coh_area_m1, lig_g, tmp_class_im, tmp_dist_im, mean_dist_area, mean_dist_area2, cpt_area, class_im, class_map):
    ...
    def run(self):
        ...
        for nb in range(nb_block):
            ...
            for lig in range(n_lig_block[nb]):
                ...
                lig_g = lig + n_lig_g
                wishart_supervised_classifier_alg(sub_n_col, self.valid, n_win_l_m1s2, lig, n_win_c_m1s2, pol_type, n_area, n_pp, cov_area_m1, m_avg, distance, det_area, pol_type_out, eps, m, coh_m1, init_minmax, coh_area_m1, lig_g, self.tmp_class_im, self.tmp_dist_im, mean_dist_area, mean_dist_area2, cpt_area, self.class_im, class_map)
