...
from polsarpro.util import span, multilook, boxcar, boxcar_dask
...
#     da_C3 = da.from_array(C3, chunks=(1500, 1500, 1, 1))

#     c11 = da_C3[..., 0, 0].real.copy()
#     c13r = da_C3[..., 0, 2].real.copy()
#     c13i = da_C3[..., 0, 2].imag.copy()
#     c22 = da_C3[..., 1, 1].real.copy()
#     c33 = da_C3[..., 2, 2].real.copy()
...
#     cnd1 = (c11 <= eps) | (c33 <= eps)
#     # in this case, fs = 0 and fd = 0
#     fv[cnd1] = 3 * (c11[cnd1] + c22[cnd1] + c33[cnd1]) / 8
#     fv[cnd1] += 2 * fv[cnd1] / 8
